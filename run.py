...
parser.add_argument('--first',  default='/home/jmw/ing/BiFormer_fi/Beanbags/frame11.png' ,   type=str,   required=False)
parser.add_argument('--second',   default='/home/jmw/ing/BiFormer_fi/Beanbags/frame13.png' ,  type=str,   required=False)
parser.add_argument('--output',  default='./out.png',   type=str,   required=False)
parser.add_argument('--target',   default='/home/jmw/ing/BiFormer_fi/Beanbags/frame12.png' ,  type=str,   required=False)
parser.add_argument('--configs',    type=str,   default='configs/BiFormer_paper.yaml')
parser.add_argument('--ckpt_path',  type=str,   default='ckpt/BiFormer_weights.pth')
