...
class vimeo_triplet_flow(Dataset):
    def __init__(self, 
                split, 
                path,
        ...
        self.flow_root = os.path.join(self.data_root, 'sequences_flows')
    ...
    def getimg(self, index):
        ...
        flowpaths = [flowpath + '/flo21.npy', flowpath + '/flo23.npy']
...
if __name__ == "__main__":    
    dataset_val=vimeo_triplet_flow(split='train',path='/data/dataset/vimeo_dataset/vimeo_triplet',crop_size=None)
    ...
    for i,item in  enumerate(val_data) :       
        ...
        flow21 = flow_vis.flow_to_color(flow[:,:,0:2], convert_to_bgr=False)    
        flow23 = flow_vis.flow_to_color(flow[:,:,2:4], convert_to_bgr=False)   
        path = './img/'+str(i)+'/'
        ...
        cv2.imwrite('./img/'+str(i)+'/'+'flow21.png',(flow21))
        cv2.imwrite('./img/'+str(i)+'/'+'flow23.png',(flow23))
